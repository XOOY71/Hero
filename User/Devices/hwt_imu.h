...
/**
  * @brief          获取底盘yaw指针（101）
  * @param[in]      none
  * @retval         单元素数组指针，point[0] = 连续yaw(rad)
  */
...
/**
  * @brief          获取云台角度指针（906）
  * @param[in]      none
  * @retval         point[0] = 连续yaw(rad), point[1] = pitch(rad)
  */
...
/**
  * @brief          提供给云台框架的角度钩子
  * @param[in]      none
  * @retval         906角度指针，point[0] = 连续yaw(rad), point[1] = pitch(rad)
  */
...
/**
  * @brief          提供给云台框架的角速度钩子
  * @param[in]      none
  * @retval         906角速度指针，point[0] = wx(rad/s), point[1] = wy(rad/s), point[2] = wz(rad/s)
  */
